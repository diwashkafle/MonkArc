...
import { LinkGitHubButton } from "@/components/ProtectedUiComponents/link-github-button"
...
export function NewJourneyForm({ githubConnected, githubUsername }: NewJourneyFormProps) {
